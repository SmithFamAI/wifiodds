...
const WIFI_AIRLINES = {
  ...
  united: {
    ...
    nextGenSplit: { mainline: { n: 159, of: 1144 }, regional: { n: 341, of: 671 } },
    ...
    system: "starlink", equipped: 500, fleet: 1815, free: "loyalty-free",
    ...
    segments: [
      { system: "starlink", n: 500, free: "loyalty-free", as: "2026-08-05",
    ...
    unresolved: { n: 217, why: "the tracker publishes no system for these tails" },
    note: "500 of 1,815 aircraft, free for MileagePlus members. Odds swing a lot by route and aircraft type.",
  },
  alaska: {
