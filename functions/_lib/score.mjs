...
const WIFI_AIRLINES = {
  ...
  united: {
    ...
    nextGenSplit: { mainline: { n: 157, of: 1144 }, regional: { n: 341, of: 671 } },
    ...
    system: "starlink", equipped: 498, fleet: 1815, free: "loyalty-free",
    ...
    segments: [
      { system: "starlink", n: 498, free: "loyalty-free", as: "2026-08-04",
    ...
    unresolved: { n: 219, why: "the tracker publishes no system for these tails" },
    note: "498 of 1,815 aircraft, free for MileagePlus members. Odds swing a lot by route and aircraft type.",
  },
  alaska: {
