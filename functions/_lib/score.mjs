/* functions/_lib/score.mjs — GENERATED FILE. DO NOT EDIT.
 *
...
const WIFI_AIRLINES = {
  ...
  united: {
    ...
    nextGenSplit: { mainline: { n: 173, of: 1145 }, regional: { n: 341, of: 672 } },
    ...
    system: "starlink", equipped: 514, fleet: 1817, free: "loyalty-free",
    ...
    segments: [
      { system: "starlink", n: 514, free: "loyalty-free", as: "2026-08-13",
    ...
    unresolved: { n: 205, why: "the tracker publishes no system for these tails" },
    note: "514 of 1,817 aircraft, free for MileagePlus members. Odds swing a lot by route and aircraft type.",
  },
  alaska: {
