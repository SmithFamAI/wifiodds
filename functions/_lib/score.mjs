...
const WIFI_AIRLINES = {
  ...
  united: {
    ...
    nextGenSplit: { mainline: { n: 155, of: 1144 }, regional: { n: 341, of: 671 } },
    ...
    system: "starlink", equipped: 496, fleet: 1815, free: "loyalty-free",
    ...
    segments: [
      { system: "starlink", n: 496, free: "loyalty-free", as: "2026-08-03",
    ...
    unresolved: { n: 221, why: "the tracker publishes no system for these tails" },
    note: "496 of 1,815 aircraft, free for MileagePlus members. Odds swing a lot by route and aircraft type.",
  },
  alaska: {
